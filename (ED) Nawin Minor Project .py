...
Label(root, text ='Nawin Hides ', font =  'arial 20 bold').pack(side =BOTTOM)
...
#reset button
Button(root, font = 'arial 10 bold' ,text ='RESET' , padx=2,width =6, command = Reset,bg = 'LimeGreen').place(x=80, y = 190)
